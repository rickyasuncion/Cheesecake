...
const Movies = () => {
    ...
    function fetchUpcomingMovies(url, callback) {
        fetch(url)
            .then(res => res.json())
            .then(json => {
                const geners = json.results.map(res => res.genre_ids);
                ...
                fetch('https://api.themoviedb.org/3/genre/movie/list?language=en&api_key=021d1a1f14e24ac19694e6363bc04b76')
                    .then(res => res.json())
                    .then(generJson => {
                        const genersWithIdsNames = uniqueGenersArr.map(generId => {
                            return generJson.genres.find(genreObj => genreObj.id === generId);
                        });
                        let p = [];
    ...
    useEffect(() => {
        fetchUpcomingMovies('https://api.themoviedb.org/3/movie/upcoming?language=en-US&page=1&api_key=021d1a1f14e24ac19694e6363bc04b76', setUpcomingMoviesGeners);
        fetchUpcomingMovies('https://api.themoviedb.org/3/movie/popular?language=en-US&page=1&api_key=021d1a1f14e24ac19694e6363bc04b76', setPopularMovieGenres);
        fetchUpcomingMovies('https://api.themoviedb.org/3/movie/top_rated?language=en-US&page=1&api_key=021d1a1f14e24ac19694e6363bc04b76', setTopRatedMovieGenres);
    }, []);
